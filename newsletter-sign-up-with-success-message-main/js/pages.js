...
function attachMainPage() {
    ...
    <header class="header-container left-item">
      <h1 class="header-title"> Stay updated!</h1>
    </header>

    <main class="main-container left-item">
      ...
      <div class="card">
        ...
        <p class="card-info">Product discovery and building what matters</p>
      </div>
      ...
      <div class="card">
        ...
        <p class="card-info">Measuring to ensure updates are a success</p>
      </div>
      ...
      <div class="card">
        ...
        <p class="card-info">And much more!</p>
      </div>

    </main>

    <footer class="footer-container left-item">
    <div class="email-container">
    <label for="">Email address</label>
    <label class="error-message" for="">Valid email required</label>
    </div>
      <input class="email-txtbox" type="text" placeholder="email@company.com">
      <button class="button-footer"> Subscribe to monthly newsletter</button>
    </footer>

    <aside class="aside-container">
      <svg class="aside-image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="400"
    ...
    let btn = document.querySelector(".button-footer");
    let email = document.querySelector(".email-txtbox");
    ...
    btn.addEventListener("click", () => {
        ...
        if (email.value) {
            ...
            email.style.backgroundColor = 'rgb(255, 220, 220)';
        }
...
function attachMessagePage() {

    let container = document.querySelector(".container");

    container.innerHTML = `
    <div class="all">
    <svg class="success-icon" xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64">
      <defs>
    ...
    <h1 class="message-title"> Thanks for subscribing!</h1>
    <p class="message-description"> A confirmation email has been sent to <span>ash@loremcompany.com</span>.
      Please open it and click the button inside to confirm your subscription.</p>
    <button class="message-button">Dismiss message</button>
  </div>`
